...
from mpl_toolkits.mplot3d import Axes3D  # Importando pacote para plotagem 3D
...
def VisualizePcaProjection(final_df, target_column):
    ...
    ax = fig.add_subplot(111, projection='3d')  # Mudança para plotagem 3D
    ax.set_xlabel('Principal Component 1', fontsize=15)
    ax.set_ylabel('Principal Component 2', fontsize=15)
    ax.set_zlabel('Principal Component 3', fontsize=15)  # Adicionando eixo z
    ...
    for target, color in zip(targets, colors):
        ...
        ax.scatter(final_df.loc[indicesToKeep, 'Principal Component 1'],
                   ...
                   final_df.loc[indicesToKeep, 'Principal Component 3'],  # Adicionando dados do eixo z
                   c=color, s=50)
    ax.legend(targets)
    ax.grid()
    plt.show()
