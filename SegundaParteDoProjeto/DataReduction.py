...
def main():
    ...
    input_file = 'C:/MineracaoDados/adult/DataNumeric_AllColumns.data'
    ...
    target = 'Income'
    df = pd.read_csv(input_file, names=names, skiprows=1)  # Ignora a primeira linha
...
def VisualizePcaProjection(finalDf, targetColumn):
    ...
    targets = finalDf[targetColumn].unique()  # Corrigido de df para finalDf
    colors = ['r', 'g']
